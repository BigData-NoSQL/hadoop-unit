...
public enum Component {
    ...
    CONFLUENT_KAFKA("confluent", "fr.jetoile.hadoopunit.component.ConfluentKafkaBootstrap", "confluent.kafka.artifact"),
    CONFLUENT_SCHEMAREGISTRY("confluent", "fr.jetoile.hadoopunit.component.ConfluentSchemaRegistryBootstrap", "confluent.schemaregistry.artifact"),
    CONFLUENT_KAFKA_REST("confluent", "fr.jetoile.hadoopunit.component.ConfluentKafkaRestBootstrap", "confluent.kafka_rest.artifact");
